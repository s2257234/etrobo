...
class Pattern_deburi(object):
    def __init__(self, power: int, state:int, status: Status) -> None:
        ...
        self.state_list = [
            ...
            Stop(self.status, 25),
<<<<<<< HEAD
            Decisive(self.status, -60, -40, side = "right", count = -110),
            Stop(self.status, 25), #state5まで
...
=======
            ...
            #青から青(右回転の後、直進)
            SelfPosition(self.status, slow, finish_position_x = 13, finish_position_y = 0, finish_position_a = 125),
            Stop(self.status, 25),
            LineTrace(self.status,very_slow, 0.05, 0.5, trace_side = "right", func = self.in_blue, target = 0.25),
>>>>>>> 0d6396ef934ab4cdec3e2090ca0a9c7564372b44
            Stop(self.status,25),
...
>>>>>>> 0d6396ef934ab4cdec3e2090ca0a9c7564372b44
            ...
            #緑から緑(左回転の後、直進)
<<<<<<< HEAD
            SelfPosition(self.status, slow, finish_position_x = 10, finish_position_y = 0, finish_position_a = -135),
            Stop(self.status, 25),
            LineTrace(self.status,very_slow, 0.05, 0.5, trace_side = "left", func = self.in_blue, target = 0.25),
=======
            SelfPosition(self.status, slow, finish_position_x = 13, finish_position_y = 0, finish_position_a = -125),
